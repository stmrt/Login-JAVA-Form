...
public class Login_page extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(77, 70, 70));

        jPanel2.setBackground(new java.awt.Color(121, 121, 104));
        ...
        jPanel3.setBackground(new java.awt.Color(140, 48, 48));
        ...
        jPanel4.setBackground(new java.awt.Color(137, 48, 48));
        ...
        jPanel5.setBackground(new java.awt.Color(63, 111, 63));
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon("C:\\Users\\Admin\\Pictures\\LoginPage\\login1.png")); // NOI18N

        jLabel8.setIcon(new javax.swing.ImageIcon("C:\\Users\\Admin\\Pictures\\LoginPage\\2.jpg")); // NOI18N
        ...
        jPasswordField1.setCaretColor(new java.awt.Color(153, 0, 0));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        RegisterInfo rgf=new RegisterInfo();
        rgf.setVisible(true);
        rgf.pack();
        rgf.setLocationRelativeTo(null);
        rgf.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        
        String PasswordTyped = new String(mdp.getPassword());
        if (compte.getText().equalsIgnoreCase("admin") && PasswordTyped.equals("Azerty")) {
            Contact getud = new Contact();
